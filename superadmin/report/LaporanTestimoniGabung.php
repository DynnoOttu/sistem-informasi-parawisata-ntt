...
<?php
    ...
    echo $_POST['tanggalselesai']. '. Objek Parawisata:';
?>

<?php
$idobjekwisata = $_POST['idobjekwisata'];
$data = mysqli_query($konektor,"select * from tbl_objekwisata where idobjekwisata like '$idobjekwisata'");
